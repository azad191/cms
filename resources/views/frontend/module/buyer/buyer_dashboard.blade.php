                                             ...
                                             <div class="wt-yourdetails wt-tabsinfo">
                                                ...
                                                <div class="wt-formtheme wt-userform">
                                                   <fieldset>
                                                      ...
                                                      <div class="form-group form-group-half toolip-wrapo">
                                                         <input type="text" value="" name="basics[first_name]" class="form-control" placeholder="Last Name">
                                                      ...
                                                      <div class="form-group toolip-wrapo">
                                                         <input type="text" name="basics[tag_line]" class="form-control count_tagline" value="" placeholder="Company ,....">

                                                      </div>

                                                      <div class="form-group form-group-half toolip-wrapo">
                                                         <input type="text" value="" name="basics[first_name]" class="form-control" placeholder="Job Title">
                                                ...
                                                <div class="wt-formtheme wt-userform">
                                                   <fieldset>
                                                      <div class="form-group form-group-half">
                                                         ...
                                                         <label>
                                                            <input type="radio" name="default" checked> Accounting & Finance
                                                         </label>
                                                      ...
                                                      <div class="form-group form-group-half toolip-wrapo">
                                                        <label><strong>No. of employees you have</strong> </label>
                                                         <label>
                                                            <input type="radio" name="default" checked> Its Just me
                                                         </label>

                                                         <label>
                                                            <input type="radio" name="default" checked> 2-9 employee
                                                         </label>
                                                   ...
                                                   <div class="wt-formtheme wt-skillsforms wt-skillsform-load-temp">
                                                      <fieldset>
                                                         <div class="form-group form-group-half ">
                                                            <span class="wt-selects" style="z-index: 2;">
                                                               <select name="skills" id="skills-dp" class="chosen-select wt-skill-title" style="display: none;">
                                                                  ...
                                                                  <option class=" level-0" value="309">Dhaka</option>
                                                                  <option class=" level-0" value="406">Khulna</option>
                                                                  <option class=" level-0" value="363">Comilla</option>
                                                         ...
                                                         <div class="form-group wt-btnarea">
                                                            <a href="#" onclick="if (!window.__cfRLUnblockHandlers) return false; event_preventDefault(event);" class="wt-btn wt-add-skill-box" data-display_type="number">Save & Update</a>
                                                         </div>
...
{{--               <div class="wt-rightarea">--}}
{{--                  <a href="#" onclick="event_preventDefault(event);" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitle1" data-toggle="collapse" data-target="#innertitle}" aria-expanded="true"><i class="lnr lnr-pencil"></i></a>--}}
{{--                  <a href="#" onclick="event_preventDefault(event);" class="wt-deleteinfo wt-delete-data"><i class="lnr lnr-trash"></i></a>--}}
{{--               </div>--}}
{{--            </div>--}}
